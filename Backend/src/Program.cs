...
//     .ReturnsAsync((Guid id, CancellationToken cancellationToken) => new Reservation(Guid.NewGuid(), Guid.NewGuid(),
//         DateTime.Now.AddDays(1), TimeSpan.FromHours(10), TimeSpan.FromHours(12)));
//
// // Setup GetAllAsync method
// mockReservationRepository.Setup(repo => repo.GetAllAsync(cancellationToken))
//     .ReturnsAsync(new List<Reservation>
//     {
//         new Reservation(Guid.NewGuid(), Guid.NewGuid(), DateTime.Now.AddDays(1), TimeSpan.FromHours(10),
//             TimeSpan.FromHours(12)),
//         new Reservation(Guid.NewGuid(), Guid.NewGuid(), DateTime.Now.AddDays(2), TimeSpan.FromHours(14),
...
// mockReservationRepository.Setup(repo =>
//         repo.GetByUserAsync(It.IsAny<Guid>(), It.IsAny<DateTime>(), It.IsAny<CancellationToken>()))
...
// mockReservationRepository.Setup(repo =>
//         repo.GetByRoomAndDateAsync(It.IsAny<Guid>(), It.IsAny<DateTime>(), It.IsAny<CancellationToken>()))
...
//         new Room("Mock Room", DateTime.Now.AddDays(1), DateTime.Now.AddMonths(6), id));
//
// // Setup GetRoomsAsync method
// mockRoomRepository.Setup(repo => repo.GetRoomsAsync(cancellationToken))
//     .ReturnsAsync(new List<Room>
//     {
//         new Room("Mock Room 1", DateTime.Now, DateTime.Now.AddMonths(1),
//             id: Guid.Parse("4a9a8b03-9205-41cc-836a-65a588780cf0")),
