...
mockReservationRepository.Setup(repo => repo.GetAsync(It.IsAny<Guid>()))
...
mockReservationRepository.Setup(repo => repo.GetAllAsync())
...
mockReservationRepository.Setup(repo => repo.AddAndMakeSureRoomIsNotChangedAsync(It.IsAny<Reservation>()))
    .Returns(Task.CompletedTask);

// Setup UpdateAsync method
mockReservationRepository.Setup(repo => repo.UpdateAsync(It.IsAny<Reservation>()))
    .Returns(Task.CompletedTask);
...
mockReservationRepository.Setup(repo => repo.GetByRoomAsync(It.IsAny<Guid>()))
...
mockReservationRepository.Setup(repo => repo.GetByUserAsync(It.IsAny<Guid>(), It.IsAny<DateTime>()))
...
mockReservationRepository.Setup(repo => repo.GetByRoomAndDateAsync(It.IsAny<Guid>(), It.IsAny<DateTime>()))
...
mockRoomRepository.Setup(repo => repo.AddRoomAsync(It.IsAny<Room>()))
    .Returns(Task.CompletedTask);

// Setup UpdateRoomAsync method
mockRoomRepository.Setup(repo => repo.UpdateRoomAsync(It.IsAny<Room>()))
    .Returns(Task.CompletedTask);

// Setup DeleteRoomAsync method
mockRoomRepository.Setup(repo => repo.DeleteRoomAsync(It.IsAny<Room>()))
    .Returns(Task.CompletedTask);
